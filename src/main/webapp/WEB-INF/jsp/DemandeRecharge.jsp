            ...
            <section class="contact-clean" style="margin-top: 50px">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach var="demande" items="${demande}" >
                                <tr>
                                    <td>${demande.id}</td>
                                    <td>${demande.idUtilisateur}</td>
                                    <td>${demande.valeur}</td>
                                    <td><a href="http://localhost:8080/AccepterdemandeRecharge?idDemande=${demande.id}&&idutilisateur=${demande.idUtilisateur}&&valeur=${demande.valeur}">accepter</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
